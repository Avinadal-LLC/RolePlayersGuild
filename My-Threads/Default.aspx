<%@ Page Title="RPG: My Threads" Language="C#" MasterPageFile="~/templates/2-Col With Authentication.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RolePlayersGuild.Threads.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRightCol" runat="server">
    <uc1:ThreadListing runat="server" ID="ThreadListing" ListType="Active Threads" />
</asp:Content>
