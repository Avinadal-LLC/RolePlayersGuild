<%@ Page Title="" Language="C#" MasterPageFile="~/templates/2-Col With Authentication.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RolePlayersGuild.Mailbox.Unanswered.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRightCol" runat="server">
    <uc1:ThreadListing runat="server" id="ThreadListing" ListType="Unanswered Threads" />
</asp:Content>
