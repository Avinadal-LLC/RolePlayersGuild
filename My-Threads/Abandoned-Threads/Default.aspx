<%@ Page Title="" Language="C#" MasterPageFile="~/templates/2-Col With Authentication.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RolePlayersGuild.Mailbox.Abandoned.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRightCol" runat="server">
    <uc1:ThreadListing runat="server" id="ThreadListing" ListType="Abandoned Threads" />
</asp:Content>
