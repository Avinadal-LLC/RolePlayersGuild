<%@ Page Title="Change RPG Funding Goal" Language="C#" MasterPageFile="~/templates/2ColAdmin.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RolePlayersGuild.Admin.FundingGoal.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="clearfix">      
        <div class="col-sm-12" style="margin: 1em 0;">
            ...
            <asp:TextBox ID="txtWeAreAt" runat="server" Width="100%" CssClass="form-control" ValidateRequestMode="Disabled" placeholder="xx.xx"></asp:TextBox>
        </div>
    </div>
