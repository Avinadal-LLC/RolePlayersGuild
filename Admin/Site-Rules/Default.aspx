<%@ Page Title="Change RPG Rules" Language="C#" MasterPageFile="~/templates/2ColAdmin.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RolePlayersGuild.Admin.SiteRules.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="clearfix">      
        <div class="col-sm-12" style="margin: 1em 0;">
            ...
            <asp:TextBox ID="txtPageContent" runat="server" Width="100%" Rows="15" TextMode="MultiLine" CssClass="form-control" ValidateRequestMode="Disabled"></asp:TextBox>
        </div>
    </div>
